...
fractal.set('project.title', 'DMPHub UI Library');
...
DMPHubTheme.addStatic(__dirname + '/fractal_subtheme', '/_subtheme');

// Use the configured theme by default:
fractal.web.theme(DMPHubTheme);
